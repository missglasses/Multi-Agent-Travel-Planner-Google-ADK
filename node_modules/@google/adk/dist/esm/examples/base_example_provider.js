...
__name(isBaseExampleProvider, "isBaseExampleProvider");
_a = BASE_EXAMPLE_PROVIDER_SIGNATURE_SYMBOL;
const _BaseExampleProvider = class _BaseExampleProvider {
  constructor() {
    /**
...
__name(_BaseExampleProvider, "BaseExampleProvider");
let BaseExampleProvider = _BaseExampleProvider;
export {
  BaseExampleProvider,
