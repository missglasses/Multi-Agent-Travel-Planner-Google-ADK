...
const _DynamicNodeScheduler = class _DynamicNodeScheduler {
  ...
  async scheduleRun(ctx, node, input, options) {
    ...
    const nodePath = ctx.nodePath ? `${ctx.nodePath}.${name}@${runId}` : `${name}@${runId}`;
