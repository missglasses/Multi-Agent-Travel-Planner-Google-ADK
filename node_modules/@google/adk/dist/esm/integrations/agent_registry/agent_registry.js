...
const _AgentRegistry = class _AgentRegistry {
  constructor(options) {
  ...
  async getMcpToolset(mcpServerName, options) {
    ...
    const combinedHeaderProvider = /* @__PURE__ */ __name(async (context) => {
      const headers = {};
...
__name(_AgentRegistry, "AgentRegistry");
let AgentRegistry = _AgentRegistry;
export {
  AgentRegistry
};
