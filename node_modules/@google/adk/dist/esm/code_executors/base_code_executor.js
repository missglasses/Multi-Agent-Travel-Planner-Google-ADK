...
__name(isBaseCodeExecutor, "isBaseCodeExecutor");
_a = BASE_CODE_EXECUTOR_SIGNATURE_SYMBOL;
const _BaseCodeExecutor = class _BaseCodeExecutor {
  constructor() {
...
__name(_BaseCodeExecutor, "BaseCodeExecutor");
let BaseCodeExecutor = _BaseCodeExecutor;
export {
  BaseCodeExecutor,
  isBaseCodeExecutor
};
