...
var import_state_write_order = require("./state_write_order.js");
/**
 * @license
...
const _BaseSessionService = class _BaseSessionService {
  ...
  updateSessionState({ session, event }) {
    ...
    for (const [key, value] of Object.entries(event.actions.stateDelta)) {
      ...
      if (!(0, import_state_write_order.shouldApplyDeltaWrite)(session.state, event.actions.stateDelta, key)) {
        continue;
      }
...
function trimTempDeltaState(event) {
  ...
  (0, import_state_write_order.carryDeltaStamps)(stateDelta, filteredStateDelta);
