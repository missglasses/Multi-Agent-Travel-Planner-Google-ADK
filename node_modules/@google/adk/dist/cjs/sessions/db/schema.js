...
const _CamelCaseToSnakeCaseJsonType = class _CamelCaseToSnakeCaseJsonType extends import_core.JsonType {
...
__name(_CamelCaseToSnakeCaseJsonType, "CamelCaseToSnakeCaseJsonType");
let CamelCaseToSnakeCaseJsonType = _CamelCaseToSnakeCaseJsonType;
let StorageMetadata = class {
};
__name(StorageMetadata, "StorageMetadata");
__decorateClass([
...
__name(StorageAppState, "StorageAppState");
__decorateClass([
...
__name(StorageUserState, "StorageUserState");
__decorateClass([
  (0, import_core.PrimaryKey)({
    type: "string",
    fieldName: "app_name",
...
__name(StorageSession, "StorageSession");
__decorateClass([
...
__name(StorageEvent, "StorageEvent");
__decorateClass([
  (0, import_core.PrimaryKey)({ type: "string", length: STORAGE_KEY_COLUMN_LENGTH })
