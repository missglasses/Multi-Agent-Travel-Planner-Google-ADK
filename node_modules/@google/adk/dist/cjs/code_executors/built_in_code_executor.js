...
__name(isBuiltInCodeExecutor, "isBuiltInCodeExecutor");
const _BuiltInCodeExecutor = class _BuiltInCodeExecutor extends (_b = import_base_code_executor.BaseCodeExecutor, _a = BUILT_IN_CODE_EXECUTOR_SIGNATURE_SYMBOL, _b) {
  constructor() {
    super(...arguments);
...
__name(_BuiltInCodeExecutor, "BuiltInCodeExecutor");
let BuiltInCodeExecutor = _BuiltInCodeExecutor;
