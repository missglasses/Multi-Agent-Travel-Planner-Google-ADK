...
const _FileArtifactService = class _FileArtifactService {
...
__name(_FileArtifactService, "FileArtifactService");
let FileArtifactService = _FileArtifactService;
...
__name(assertSafeSegment, "assertSafeSegment");
...
__name(assertInsideRoot, "assertInsideRoot");
...
__name(getSessionArtifactsDir, "getSessionArtifactsDir");
function getVersionsDir(artifactDir) {
  return path.join(artifactDir, "versions");
}
__name(getVersionsDir, "getVersionsDir");
...
__name(getArtifactDir, "getArtifactDir");
...
__name(getArtifactVersionsFromDir, "getArtifactVersionsFromDir");
...
__name(readMetadata, "readMetadata");
...
__name(getLatestMetadata, "getLatestMetadata");
...
__name(iterateArtifactDirs, "iterateArtifactDirs");
...
__name(asPosixPath, "asPosixPath");
