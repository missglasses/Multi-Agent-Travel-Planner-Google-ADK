...
var scoped_artifact_service_exports = {};
__export(scoped_artifact_service_exports, {
  ScopedArtifactService: () => ScopedArtifactService
});
module.exports = __toCommonJS(scoped_artifact_service_exports);
/**
 * @license
 * Copyright 2026 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const _ScopedArtifactService = class _ScopedArtifactService {
  constructor(delegate, appName, userId, sessionId) {
  ...
  async listArtifactVersions(filename) {
...
__name(_ScopedArtifactService, "ScopedArtifactService");
let ScopedArtifactService = _ScopedArtifactService;
