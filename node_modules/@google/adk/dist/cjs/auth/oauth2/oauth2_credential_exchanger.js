 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _OAuth2CredentialExchanger = class _OAuth2CredentialExchanger {
  async exchange({
    authCredential,
    authScheme
  }) {
...
__name(_OAuth2CredentialExchanger, "OAuth2CredentialExchanger");
let OAuth2CredentialExchanger = _OAuth2CredentialExchanger;
...
__name(determineGrantType, "determineGrantType");
...
__name(exchangeClientCredentials, "exchangeClientCredentials");
