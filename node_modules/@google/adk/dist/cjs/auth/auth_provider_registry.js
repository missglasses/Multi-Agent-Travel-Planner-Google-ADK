...
var auth_provider_registry_exports = {};
__export(auth_provider_registry_exports, {
  AuthProviderRegistry: () => AuthProviderRegistry
});
module.exports = __toCommonJS(auth_provider_registry_exports);
/**
 * @license
 * Copyright 2026 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const _AuthProviderRegistry = class _AuthProviderRegistry {
  constructor() {
...
__name(_AuthProviderRegistry, "AuthProviderRegistry");
let AuthProviderRegistry = _AuthProviderRegistry;
