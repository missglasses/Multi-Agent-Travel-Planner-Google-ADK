...
__name(toGeminiType, "toGeminiType");
const getTypeFromArrayItem = /* @__PURE__ */ __name((mcpType) => {
  var _a, _b;
...
function toGeminiSchema(mcpSchema) {
  ...
  __name(recursiveConvert, "recursiveConvert");
  return recursiveConvert(mcpSchema);
}
__name(toGeminiSchema, "toGeminiSchema");
