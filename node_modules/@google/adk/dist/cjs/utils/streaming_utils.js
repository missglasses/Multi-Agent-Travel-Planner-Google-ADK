...
const _ProgressiveStrategy = class _ProgressiveStrategy {
  constructor() {
    this.partsSequence = [];
    ...
    if (this.currentFcName) {
      const fcPart = {
        functionCall: {
          ...
          id: (_a = this.currentFcId) != null ? _a : (0, import_event.generateClientFunctionCallId)()
        }
      };
  ...
  processFunctionCallPart(part) {
    ...
    if (fc.partialArgs || fc.willContinue) {
      if (!fc.id && !this.currentFcId) {
        fc.id = (0, import_event.generateClientFunctionCallId)();
      }
...
__name(_ProgressiveStrategy, "ProgressiveStrategy");
let ProgressiveStrategy = _ProgressiveStrategy;
const _NonProgressiveStrategy = class _NonProgressiveStrategy {
  constructor() {
    this.text = "";
    this.thoughtText = "";
  }
    ...
    if ((_a = llmResponse.content) == null ? void 0 : _a.parts) {
      ...
      for (const part of llmResponse.content.parts) {
        ...
        if (part.functionCall && !part.functionCall.id) {
          part.functionCall.id = (0, import_event.generateClientFunctionCallId)();
        }
...
__name(_NonProgressiveStrategy, "NonProgressiveStrategy");
let NonProgressiveStrategy = _NonProgressiveStrategy;
const _StreamingResponseAggregator = class _StreamingResponseAggregator {
...
__name(_StreamingResponseAggregator, "StreamingResponseAggregator");
let StreamingResponseAggregator = _StreamingResponseAggregator;
...
__name(isEmptyContentPart, "isEmptyContentPart");
