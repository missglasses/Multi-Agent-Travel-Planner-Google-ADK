...
__name(isZodV3Schema, "isZodV3Schema");
...
function zodObjectToSchema(schema) {
  ...
  if (isZodV3Schema(schema)) {
    return (0, import_zod_to_json_schema.zodToJsonSchema)(schema, {
      ...
      postProcess: /* @__PURE__ */ __name((jsonSchema) => {
...
__name(zodObjectToSchema, "zodObjectToSchema");
