...
const toCamelCaseKey = /* @__PURE__ */ __name((key) => key.replace(
  /_([a-z])/g,
  (_match, letter) => letter.toUpperCase()
), "toCamelCaseKey");
const toSnakeCaseKey = /* @__PURE__ */ __name((key) => key.replace(/[A-Z]/g, (g) => "_" + g.toLowerCase()), "toSnakeCaseKey");
