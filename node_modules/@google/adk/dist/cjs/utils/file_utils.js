 ...
 * SPDX-License-Identifier: Apache-2.0
 */
function isInsideDir(resolvedPath, resolvedBaseDir) {
  return resolvedPath === resolvedBaseDir || resolvedPath.startsWith(resolvedBaseDir + path.sep);
}
__name(isInsideDir, "isInsideDir");
async function materializeFiles(files, dir) {
...
__name(materializeFiles, "materializeFiles");
