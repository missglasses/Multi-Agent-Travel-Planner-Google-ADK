...
const _ApigeeLlm = class _ApigeeLlm extends import_google_llm.Gemini {
  constructor({
    model,
    proxyUrl,
    apiKey,
...
__name(_ApigeeLlm, "ApigeeLlm");
/**
 * A list of model name patterns that are supported by this LLM.
 *
 * @returns A list of supported models.
 */
_ApigeeLlm.supportedModels = [
  /apigee\/.*/
];
let ApigeeLlm = _ApigeeLlm;
...
__name(apigeeToGeminiInitParams, "apigeeToGeminiInitParams");
