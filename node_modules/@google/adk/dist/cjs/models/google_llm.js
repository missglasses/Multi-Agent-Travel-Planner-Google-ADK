...
__name(isGemini, "isGemini");
const _Gemini = class _Gemini extends (_b = import_base_llm.BaseLlm, _a = GEMINI_MODEL_SYMBOL, _b) {
  /**
...
__name(removeDisplayNameIfPresent, "removeDisplayNameIfPresent");
function geminiInitParams({
  ...
  if (!params.vertexai && !(0, import_env_aware_utils.isBrowser)()) {
    params.vertexai = (0, import_env_aware_utils.isEnterpriseModeEnabled)();
  }
  if (params.vertexai) {
    ...
    if (!params.apiKey && !(0, import_env_aware_utils.isBrowser)()) {
      params.apiKey = process.env["GOOGLE_GENAI_API_KEY"] || process.env["GOOGLE_API_KEY"] || process.env["GEMINI_API_KEY"];
    }
  }
  return params;
}
__name(geminiInitParams, "geminiInitParams");
