...
var routed_llm_exports = {};
__export(routed_llm_exports, {
  RoutedLlm: () => RoutedLlm
});
module.exports = __toCommonJS(routed_llm_exports);
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _RoutedLlm = class _RoutedLlm extends import_base_llm.BaseLlm {
  constructor({
    models,
    router,
  ...
  async *generateContentAsync(llmRequest, stream) {
    import_logger.logger.info(`Routing request via ${this.model}`);
  ...
  async connect(llmRequest) {
    const generator = (0, import_failover_utils.runWithRouting)(
      this.models,
      llmRequest,
      this.router,
...
__name(_RoutedLlm, "RoutedLlm");
let RoutedLlm = _RoutedLlm;
