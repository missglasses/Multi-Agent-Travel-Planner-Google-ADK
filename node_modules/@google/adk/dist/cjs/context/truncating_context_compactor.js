 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _TruncatingContextCompactor = class _TruncatingContextCompactor {
  constructor(options) {
    var _a;
...
__name(_TruncatingContextCompactor, "TruncatingContextCompactor");
let TruncatingContextCompactor = _TruncatingContextCompactor;
