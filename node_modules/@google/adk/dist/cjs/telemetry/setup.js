...
__name(maybeSetOtelProviders, "maybeSetOtelProviders");
function getOtelResource() {
  return (0, import_resources.detectResources)({
    detectors: []
  });
}
__name(getOtelResource, "getOtelResource");
...
__name(getOtelExportersConfig, "getOtelExportersConfig");
...
__name(getOtelExporters, "getOtelExporters");
