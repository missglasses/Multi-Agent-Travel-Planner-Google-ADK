...
__export(tracing_exports, {
  ...
  traceWorkflowInvocation: () => traceWorkflowInvocation,
  tracer: () => tracer
});
...
__name(safeJsonSerialize, "safeJsonSerialize");
...
__name(traceAgentInvocation, "traceAgentInvocation");
function traceWorkflowInvocation({
  workflowName,
  nodePath,
  sessionId
}) {
...
__name(traceWorkflowInvocation, "traceWorkflowInvocation");
function traceNodeExecution({
  nodePath,
  runId,
  attempt,
  status,
...
__name(traceNodeExecution, "traceNodeExecution");
...
__name(traceToolCall, "traceToolCall");
...
__name(traceMergedToolCalls, "traceMergedToolCalls");
function traceCallLlm({
  ...
  span.setAttributes({
    ...
    ...((_a = invocationContext.agent) == null ? void 0 : _a.name) ? { [GEN_AI_AGENT_NAME]: invocationContext.agent.name } : {},
  ...
  if ((_b = llmRequest.config) == null ? void 0 : _b.topP) {
    span.setAttribute("gen_ai.request.top_p", llmRequest.config.topP);
  }
  if (((_c = llmRequest.config) == null ? void 0 : _c.maxOutputTokens) !== void 0) {
    span.setAttribute(
  ...
  if ((_d = llmResponse.usageMetadata) == null ? void 0 : _d.candidatesTokenCount) {
    span.setAttribute(
...
__name(traceCallLlm, "traceCallLlm");
...
__name(traceSendData, "traceSendData");
...
__name(buildLlmRequestForTrace, "buildLlmRequestForTrace");
...
__name(bindOtelContextToAsyncGenerator, "bindOtelContextToAsyncGenerator");
...
__name(runAsyncGeneratorWithOtelContext, "runAsyncGeneratorWithOtelContext");
function shouldAddRequestResponseToSpans() {
  const envValue = process.env.ADK_CAPTURE_MESSAGE_CONTENT_IN_SPANS || "true";
  return envValue === "true" || envValue === "1";
}
__name(shouldAddRequestResponseToSpans, "shouldAddRequestResponseToSpans");
