 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _LiveRequestQueue = class _LiveRequestQueue {
  constructor() {
  ...
  async get(abortSignal) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const resolveFn = /* @__PURE__ */ __name((req) => {
...
__name(_LiveRequestQueue, "LiveRequestQueue");
let LiveRequestQueue = _LiveRequestQueue;
