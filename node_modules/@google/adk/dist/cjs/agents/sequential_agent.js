...
__name(isSequentialAgent, "isSequentialAgent");
let SequentialAgent = class extends (_b = import_base_agent.BaseAgent, _a = SEQUENTIAL_AGENT_SIGNATURE_SYMBOL, _b) {
  constructor() {
    super(...arguments);
    /**
        ...
        if (!taskCompletedToolAlreadyAdded) {
          subAgent.tools.push(
            new import_function_tool.FunctionTool({
              ...
              execute: /* @__PURE__ */ __name(() => "Task completion signaled.", "execute")
            })
          );
...
__name(SequentialAgent, "SequentialAgent");
SequentialAgent = __decorateClass([
