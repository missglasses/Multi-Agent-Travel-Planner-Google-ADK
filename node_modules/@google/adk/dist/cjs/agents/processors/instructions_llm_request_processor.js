 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _InstructionsLlmRequestProcessor = class _InstructionsLlmRequestProcessor extends import_base_llm_processor.BaseLlmRequestProcessor {
  /**
  ...
  async *runAsync(invocationContext, llmRequest) {
    ...
    if (agent.outputSchema && ((_a = agent.tools) == null ? void 0 : _a.length) && !(0, import_output_schema_utils.canUseOutputSchemaWithTools)(agent.canonicalModel.model)) {
