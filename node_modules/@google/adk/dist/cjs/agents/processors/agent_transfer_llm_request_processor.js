 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _AgentTransferLlmRequestProcessor = class _AgentTransferLlmRequestProcessor extends import_base_llm_processor.BaseLlmRequestProcessor {
  constructor() {
    super(...arguments);
    ...
    this.tool = new import_function_tool.FunctionTool({
      ...
      execute: /* @__PURE__ */ __name(function(args, toolContext) {
        if (!toolContext) {
...
__name(_AgentTransferLlmRequestProcessor, "AgentTransferLlmRequestProcessor");
let AgentTransferLlmRequestProcessor = _AgentTransferLlmRequestProcessor;
