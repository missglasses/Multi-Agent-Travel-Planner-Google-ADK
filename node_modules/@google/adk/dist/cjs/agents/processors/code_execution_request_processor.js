 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _CodeExecutionRequestProcessor = class _CodeExecutionRequestProcessor extends import_base_llm_processor.BaseLlmRequestProcessor {
...
__name(_CodeExecutionRequestProcessor, "CodeExecutionRequestProcessor");
let CodeExecutionRequestProcessor = _CodeExecutionRequestProcessor;
...
{df_info}""")
`;
const _CodeExecutionResponseProcessor = class _CodeExecutionResponseProcessor {
  /**
...
__name(_CodeExecutionResponseProcessor, "CodeExecutionResponseProcessor");
let CodeExecutionResponseProcessor = _CodeExecutionResponseProcessor;
...
__name(runPostProcessor, "runPostProcessor");
...
__name(extractAndReplaceInlineFiles, "extractAndReplaceInlineFiles");
...
__name(getOrSetExecutionId, "getOrSetExecutionId");
async function postProcessCodeExecutionResult(invocationContext, codeExecutorContext, codeExecutionResult) {
  ...
  return (0, import_event.createEvent)({
    invocationId: invocationContext.invocationId,
    author: (0, import_invocation_context.requireAgent)(invocationContext).name,
    branch: invocationContext.branch,
    content: resultContent,
    actions: eventActions
  });
}
__name(postProcessCodeExecutionResult, "postProcessCodeExecutionResult");
...
__name(getDataFilePreprocessingCode, "getDataFilePreprocessingCode");
