 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _BasicLlmRequestProcessor = class _BasicLlmRequestProcessor extends import_base_llm_processor.BaseLlmRequestProcessor {
  /**
  ...
  async *runAsync(invocationContext, llmRequest) {
    ...
    if (agent.outputSchema && agent.mode !== "task" && (!((_b = agent.tools) == null ? void 0 : _b.length) || (0, import_output_schema_utils.canUseOutputSchemaWithTools)(agent.canonicalModel.model))) {
...
__name(_BasicLlmRequestProcessor, "BasicLlmRequestProcessor");
let BasicLlmRequestProcessor = _BasicLlmRequestProcessor;
