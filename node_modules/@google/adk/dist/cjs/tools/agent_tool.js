...
const _AgentTool = class _AgentTool extends (_b = import_base_tool.BaseTool, _a = AGENT_TOOL_SIGNATURE_SYMBOL, _b) {
  constructor(config) {
    super({
...
__name(_AgentTool, "AgentTool");
let AgentTool = _AgentTool;
