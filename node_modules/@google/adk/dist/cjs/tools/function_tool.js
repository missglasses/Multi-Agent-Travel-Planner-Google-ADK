...
const _FunctionTool = class _FunctionTool extends (_b = import_base_tool.BaseTool, _a = FUNCTION_TOOL_SIGNATURE_SYMBOL, _b) {
  /**
  ...
  async checkConfirmation(input, toolContext) {
    ...
    if (!toolContext.toolConfirmation) {
      toolContext.requestConfirmation({
        hint: `Please approve or reject the tool call ${this.name}() by responding with a FunctionResponse with an expected ToolConfirmation payload.`
      });
