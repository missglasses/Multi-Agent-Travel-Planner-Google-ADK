...
let SkillToolset = class extends import_base_toolset.BaseToolset {
  constructor(skills, options = {}) {
    ...
    if (options.allowInlineScripts) {
      this.tools.push(new import_run_skill_inline_script_tool.RunSkillInlineScriptTool(this));
    }
    if (this.registry) {
  ...
  getScriptOutputDir() {
    ...
    return (_a = this.tempOutputDir) != null ? _a : this.tempOutputDir = fs.mkdtemp(
...
__name(SkillToolset, "SkillToolset");
