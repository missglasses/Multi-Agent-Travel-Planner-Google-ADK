...
__name(isInlineMimeTypeSupported, "isInlineMimeTypeSupported");
...
__name(asSafePartForLlm, "asSafePartForLlm");
const _LoadArtifactsTool = class _LoadArtifactsTool extends import_base_tool.BaseTool {
  constructor() {
    super({
      name: "load_artifacts",
...
__name(_LoadArtifactsTool, "LoadArtifactsTool");
let LoadArtifactsTool = _LoadArtifactsTool;
