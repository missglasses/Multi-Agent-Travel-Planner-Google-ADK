 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _PreloadMemoryTool = class _PreloadMemoryTool extends import_base_tool.BaseTool {
  constructor() {
    super({
...
__name(_PreloadMemoryTool, "PreloadMemoryTool");
let PreloadMemoryTool = _PreloadMemoryTool;
