...
var load_mcp_resource_tool_exports = {};
__export(load_mcp_resource_tool_exports, {
  LoadMcpResourceTool: () => LoadMcpResourceTool
});
module.exports = __toCommonJS(load_mcp_resource_tool_exports);
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _LoadMcpResourceTool = class _LoadMcpResourceTool extends import_base_tool.BaseTool {
...
before answering questions related to the resources.`
      ...
      import_logger.logger.warn(`Failed to list MCP resources: ${e}`);
    }
    ...
    for (const resourceName of requestedResourceNames) {
      try {
        ...
        import_logger.logger.warn(`Failed to read MCP resource '${resourceName}': ${e}`);
      }
    }
  }
