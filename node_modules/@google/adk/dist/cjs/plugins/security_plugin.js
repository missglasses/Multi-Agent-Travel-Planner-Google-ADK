...
__export(security_plugin_exports, {
  ...
  REQUEST_CONFIRMATION_FUNCTION_CALL_NAME: () => import_functions.REQUEST_CONFIRMATION_FUNCTION_CALL_NAME,
...
const _InMemoryPolicyEngine = class _InMemoryPolicyEngine {
  /**
...
__name(_InMemoryPolicyEngine, "InMemoryPolicyEngine");
let InMemoryPolicyEngine = _InMemoryPolicyEngine;
const _SecurityPlugin = class _SecurityPlugin extends import_base_plugin.BasePlugin {
  /**
...
__name(_SecurityPlugin, "SecurityPlugin");
let SecurityPlugin = _SecurityPlugin;
function getAskUserConfirmationFunctionCalls(event) {
  ...
  for (const part of event.content.parts) {
    if (part && part.functionCall && part.functionCall.name === import_functions.REQUEST_CONFIRMATION_FUNCTION_CALL_NAME) {
      results.push(part.functionCall);
    }
  }
  return results;
}
__name(getAskUserConfirmationFunctionCalls, "getAskUserConfirmationFunctionCalls");
