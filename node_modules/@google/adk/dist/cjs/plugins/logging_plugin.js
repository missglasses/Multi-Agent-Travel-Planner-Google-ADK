 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _LoggingPlugin = class _LoggingPlugin extends import_base_plugin.BasePlugin {
  /**
  ...
  async onUserMessageCallback({
    ...
    this.log(`   Root Agent: ${(_b = (_a = invocationContext.agent) == null ? void 0 : _a.name) != null ? _b : "Unknown"}`);
  ...
  async beforeRunCallback({
    ...
    this.log(`   Invocation ID: ${invocationContext.invocationId}`);
    this.log(
      `   Starting Agent: ${(_b = (_a = invocationContext.agent) == null ? void 0 : _a.name) != null ? _b : "Unknown"}`
    );
    return void 0;
  }
  ...
  async afterRunCallback({
    ...
    this.log(`   Invocation ID: ${invocationContext.invocationId}`);
    this.log(`   Final Agent: ${(_b = (_a = invocationContext.agent) == null ? void 0 : _a.name) != null ? _b : "Unknown"}`);
    return void 0;
  }
