 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _A2ARemoteAgentRunProcessor = class _A2ARemoteAgentRunProcessor {
  constructor(request) {
  ...
  buildNonPartialAggregation(context, agg) {
    ...
    const result = (0, import_event.createEvent)({
      author: (0, import_invocation_context.requireAgent)(context).name,
...
__name(_A2ARemoteAgentRunProcessor, "A2ARemoteAgentRunProcessor");
let A2ARemoteAgentRunProcessor = _A2ARemoteAgentRunProcessor;
