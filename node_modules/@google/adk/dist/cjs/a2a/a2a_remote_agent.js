 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const _RemoteA2AAgent = class _RemoteA2AAgent extends import_base_agent.BaseAgent {
    ...
    try {
      ...
      if (useStreaming) {
        for await (const chunk of this.client.sendMessageStream(params)) {
          ...
          const adkEvent = (0, import_event_converter_utils.toAdkEvent)(
            chunk,
...
__name(_RemoteA2AAgent, "RemoteA2AAgent");
let RemoteA2AAgent = _RemoteA2AAgent;
