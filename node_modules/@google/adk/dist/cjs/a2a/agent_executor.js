...
const _A2AAgentExecutor = class _A2AAgentExecutor {
  ...
  async execute(ctx, eventBus) {
    ...
    try {
      ...
      const unansweredRequestEvent = (0, import_event_processor_utils.getUnansweredRequestEvent)({
        taskId: ctx.taskId,
