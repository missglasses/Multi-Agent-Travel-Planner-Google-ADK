...
__name(shouldFilterOutEvent, "shouldFilterOutEvent");
...
__name(toVertexMetadataValue, "toVertexMetadataValue");
const _VertexAiMemoryBankService = class _VertexAiMemoryBankService {
  constructor(options) {
    ...
    if (options.client) {
      ...
      if (this.expressModeApiKey && (!this.projectId || !this.location)) {
        throw new Error(import_vertex_ai_utils.EXPRESS_MODE_UNSUPPORTED_MESSAGE);
      }
...
__name(_VertexAiMemoryBankService, "VertexAiMemoryBankService");
let VertexAiMemoryBankService = _VertexAiMemoryBankService;
...
__name(buildCreateMemoryConfig, "buildCreateMemoryConfig");
...
__name(extractRevisionLabels, "extractRevisionLabels");
...
__name(buildVertexMetadata, "buildVertexMetadata");
...
__name(buildGenerateMemoriesConfig, "buildGenerateMemoriesConfig");
...
__name(normalizeMemoriesForCreate, "normalizeMemoriesForCreate");
...
__name(memoryEntryToFact, "memoryEntryToFact");
...
__name(mergeCustomMetadataForMemory, "mergeCustomMetadataForMemory");
...
__name(revisionLabelsForMemory, "revisionLabelsForMemory");
...
__name(isConsolidationEnabled, "isConsolidationEnabled");
...
__name(iterMemoryBatches, "iterMemoryBatches");
