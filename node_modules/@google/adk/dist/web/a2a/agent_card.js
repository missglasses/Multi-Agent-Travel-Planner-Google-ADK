...
__name(resolveAgentCard, "resolveAgentCard");
...
__name(buildAgentSkills, "buildAgentSkills");
    ...
    return [
      {
        id: agent.name,
        name: "workflow",
        description: agent.description || "Workflow ".concat(agent.name),
        tags: ["workflow"]
      }
    ];
  }
...
__name(buildPrimarySkills, "buildPrimarySkills");
...
__name(buildSubAgentSkills, "buildSubAgentSkills");
...
__name(buildLLMAgentSkills, "buildLLMAgentSkills");
...
__name(toolToSkill, "toolToSkill");
...
__name(buildNonLLMAgentSkills, "buildNonLLMAgentSkills");
...
__name(buildAgentDescription, "buildAgentDescription");
...
__name(buildSequentialAgentDescription, "buildSequentialAgentDescription");
...
__name(buildParallelAgentDescription, "buildParallelAgentDescription");
...
__name(buildLoopAgentDescription, "buildLoopAgentDescription");
...
__name(buildDescriptionFromInstructions, "buildDescriptionFromInstructions");
...
__name(replacePronouns, "replacePronouns");
...
__name(getDefaultAgentDescription, "getDefaultAgentDescription");
...
__name(getAgentTypeTag, "getAgentTypeTag");
...
__name(getAgentSkillName, "getAgentSkillName");
function isCompositeShellAgent(agent) {
  return isLoopAgent(agent) || isSequentialAgent(agent) || isParallelAgent(agent);
}
__name(isCompositeShellAgent, "isCompositeShellAgent");
export {
  buildAgentSkills,
  getA2AAgentCard,
  resolveAgentCard
