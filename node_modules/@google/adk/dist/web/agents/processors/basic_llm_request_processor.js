...
const _BasicLlmRequestProcessor = class _BasicLlmRequestProcessor extends BaseLlmRequestProcessor {
  /**
  ...
  runAsync(invocationContext, llmRequest) {
    return __asyncGenerator(this, null, function* () {
      ...
      if (agent.outputSchema && agent.mode !== "task" && (!((_b = agent.tools) == null ? void 0 : _b.length) || canUseOutputSchemaWithTools(agent.canonicalModel.model))) {
