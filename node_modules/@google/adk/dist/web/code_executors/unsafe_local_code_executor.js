...
function isPowerShellCommand(commandPath) {
  return /^(powershell|pwsh)(\.exe)?$/i.test(path.win32.basename(commandPath));
}
__name(isPowerShellCommand, "isPowerShellCommand");
...
__name(createTempScriptFile, "createTempScriptFile");
...
__name(getExtensionForLanguage, "getExtensionForLanguage");
const _UnsafeLocalCodeExecutor = class _UnsafeLocalCodeExecutor extends BaseCodeExecutor {
  constructor(options = {}) {
    var _a, _b, _c, _d;
    super();
...
__name(_UnsafeLocalCodeExecutor, "UnsafeLocalCodeExecutor");
let UnsafeLocalCodeExecutor = _UnsafeLocalCodeExecutor;
export {
