...
const _BaseNode = class _BaseNode {
  ...
  run(ctx, input) {
    return __asyncGenerator(this, null, function* () {
      ...
      try {
        for (var iter = __forAwait(this.runImpl(ctx, validatedInput)), more, temp, error; more = !(temp = yield new __await(iter.next())).done; more = false) {
