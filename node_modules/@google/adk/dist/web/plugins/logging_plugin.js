...
const _LoggingPlugin = class _LoggingPlugin extends BasePlugin {
  /**
  ...
  async onUserMessageCallback({
    ...
    this.log("   Root Agent: ".concat((_b = (_a = invocationContext.agent) == null ? void 0 : _a.name) != null ? _b : "Unknown"));
  ...
  async beforeRunCallback({
    ...
    this.log("   Invocation ID: ".concat(invocationContext.invocationId));
    this.log(
      "   Starting Agent: ".concat((_b = (_a = invocationContext.agent) == null ? void 0 : _a.name) != null ? _b : "Unknown")
    );
    return void 0;
  }
  ...
  async afterRunCallback({
    ...
    this.log("   Invocation ID: ".concat(invocationContext.invocationId));
    this.log("   Final Agent: ".concat((_b = (_a = invocationContext.agent) == null ? void 0 : _a.name) != null ? _b : "Unknown"));
    return void 0;
  }
...
__name(_LoggingPlugin, "LoggingPlugin");
let LoggingPlugin = _LoggingPlugin;
export {
  LoggingPlugin
};
