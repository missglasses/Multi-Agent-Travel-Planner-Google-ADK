...
let RunSkillScriptTool = class extends BaseTool {
  ...
  async runAsync({
    ...
    try {
      ...
      return __spreadProps(__spreadValues({}, result), { outputDirectory: outputDir });
    } catch (e) {
      return {
...
__name(RunSkillScriptTool, "RunSkillScriptTool");
...
__name(buildWrapperCode, "buildWrapperCode");
...
__name(getSkillResourceFiles, "getSkillResourceFiles");
export {
  RunSkillScriptTool,
