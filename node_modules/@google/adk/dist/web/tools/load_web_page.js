...
function failedToFetchMessage(url) {
  return "Failed to fetch url: ".concat(url);
}
...
function hextetsToBigInt(hextets) {
  ...
  for (const hextet of hextets) {
    value = value << /* @__PURE__ */ BigInt("16") | BigInt(hextet);
  }
  return value;
}
...
function isBlockedIpv6(hextets) {
  ...
  if (value >> /* @__PURE__ */ BigInt("32") === /* @__PURE__ */ BigInt("0xffff")) {
    return isBlockedIpv4([
      Number(value >> /* @__PURE__ */ BigInt("24") & /* @__PURE__ */ BigInt("0xff")),
      Number(value >> /* @__PURE__ */ BigInt("16") & /* @__PURE__ */ BigInt("0xff")),
      Number(value >> /* @__PURE__ */ BigInt("8") & /* @__PURE__ */ BigInt("0xff")),
      Number(value & /* @__PURE__ */ BigInt("0xff"))
    ]);
  }
...
async function resolveHostAddresses(hostname) {
  ...
  if (addresses.length === 0) {
    throw new Error("Unable to resolve host: ".concat(hostname));
  }
  return addresses;
}
...
function assertUrlAllowed(url) {
  ...
  if (!ALLOWED_SCHEMES.has(parsed.protocol)) {
    throw new Error("Unsupported url scheme: ".concat(url));
  }
  if (isBlockedHostname(parsed.hostname)) {
    throw new Error("Blocked host: ".concat(parsed.hostname));
  }
  return parsed;
}
...
async function validateResolvedAddresses(hostname) {
  ...
  if (addresses.some(isBlockedAddress)) {
    throw new Error("Blocked host: ".concat(hostname));
  }
}
...
const LOAD_WEB_PAGE = new FunctionTool({
  name: "load_web_page",
