...
__name(isBaseTool, "isBaseTool");
_a = BASE_TOOL_SIGNATURE_SYMBOL;
const _BaseTool = class _BaseTool {
  /**
   ...
   */
  async checkRequireConfirmation(_args, _toolContext) {
    return false;
  }
  /**
...
__name(_BaseTool, "BaseTool");
let BaseTool = _BaseTool;
...
__name(findToolWithFunctionDeclarations, "findToolWithFunctionDeclarations");
export {
  BaseTool,
  isBaseTool
};
