...
const _RoutedLlm = class _RoutedLlm extends BaseLlm {
  constructor({
    models,
    router,
    ...
    const modelNames = Object.entries(modelsMap).map(
      ([name, model]) => "".concat(name, " (").concat(model.model, ")")
    );
    const computedName = "RoutedLlm[".concat(modelNames.join(", "), "]");
  ...
  generateContentAsync(llmRequest, stream) {
    return __asyncGenerator(this, null, function* () {
      logger.info("Routing request via ".concat(this.model));
