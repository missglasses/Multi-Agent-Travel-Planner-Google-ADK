...
function isEnterpriseModeEnabled() {
  ...
  if (((_b = process.env) == null ? void 0 : _b[ENTERPRISE_MODE_ENV_VAR]) !== void 0) {
    if (deprecatedIsSet) {
      warnDeprecatedEnterpriseModeEnvVar(
        "".concat(DEPRECATED_ENTERPRISE_MODE_ENV_VAR, " is set but ignored because ") + "".concat(ENTERPRISE_MODE_ENV_VAR, " takes precedence. ") + "".concat(DEPRECATED_ENTERPRISE_MODE_ENV_VAR, " is deprecated, please use ") + "".concat(ENTERPRISE_MODE_ENV_VAR, " instead.")
      );
    }
  ...
  if (deprecatedIsSet) {
    warnDeprecatedEnterpriseModeEnvVar(
      "".concat(DEPRECATED_ENTERPRISE_MODE_ENV_VAR, " is deprecated, please use ") + "".concat(ENTERPRISE_MODE_ENV_VAR, " instead")
    );
