...
const _GcsArtifactService = class _GcsArtifactService {
  ...
  getBucket() {
    var _a;
    (_a = this.bucketPromise) != null ? _a : this.bucketPromise = loadOptionalPeer(
      { packageName: "@google-cloud/storage", feature: "GcsArtifactService" },
      () => Promise.resolve().then(() => __toESM(require("@google-cloud/storage"), 1))
    ).then(
      ({ Storage }) => new Storage(this.storageOptions).bucket(this.bucketName)
    );
...
__name(_GcsArtifactService, "GcsArtifactService");
let GcsArtifactService = _GcsArtifactService;
...
__name(extractArtifactKeys, "extractArtifactKeys");
...
__name(getFileNameFromPath, "getFileNameFromPath");
export {
  GcsArtifactService
};
