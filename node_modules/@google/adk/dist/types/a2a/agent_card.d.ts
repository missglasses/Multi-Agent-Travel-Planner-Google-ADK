 ...
 */
export declare function getA2AAgentCard(agent: RunnableRoot, transports: AgentInterface[]): Promise<AgentCard>;
/**
 ...
 */
export declare function buildAgentSkills(agent: RunnableRoot): Promise<AgentSkill[]>;
