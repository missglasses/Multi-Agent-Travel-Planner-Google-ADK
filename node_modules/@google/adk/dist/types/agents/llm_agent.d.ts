 ...
 */
export declare class LlmAgent extends BaseAgent<LlmAgentConfig> {
     ...
     */
    private runLiveFlow;
    private runLivePreprocess;
    private runSendLoop;
    private dispatchLiveRequest;
    /**
