 ...
 *   errors".
 */
export declare function normalizeRetryExceptions(exceptions?: Array<string | ErrorClass> | null): string[] | undefined;
/**
 ...
 */
export declare function prepareRetryConfig(config: RetryConfig): PreparedRetryConfig;
