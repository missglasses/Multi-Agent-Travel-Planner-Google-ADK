 ...
 */
export type ToolExecuteFunction<TParameters extends ToolInputParameters> = (input: ToolExecuteArgument<TParameters>, toolContext?: Context) => Promise<unknown> | unknown;
/**
 ...
 */
export type RequireConfirmation<TParameters extends ToolInputParameters> = boolean | ((input: ToolExecuteArgument<TParameters>, toolContext?: Context) => boolean | Promise<boolean>);
/**
...
export declare class FunctionTool<TParameters extends ToolInputParameters = undefined> extends BaseTool {
     ...
     */
    checkRequireConfirmation(args: Record<string, unknown>, toolContext?: Context): Promise<boolean>;
    ...
    private evaluateRequireConfirmation;
    /**
