...
class InMemoryExporter {
  ...
  export(spans, resultCallback) {
    for (const span of spans) {
      ...
      const attributes = span.attributes;
      const sessionId = attributes["gcp.vertex.agent.session_id"] ?? attributes["gen_ai.conversation.id"];
      if (sessionId) {
