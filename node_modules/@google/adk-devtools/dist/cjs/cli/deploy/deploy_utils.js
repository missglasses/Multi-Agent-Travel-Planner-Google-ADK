...
function assertSafeDockerfileToken(value, label) {
...
function assertNoDockerfileNewline(value, label) {
  if (/[\r\n]/.test(value)) {
    throw new Error(
